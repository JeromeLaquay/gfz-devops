...
onMounted(() => {
  ...
  if (!token.value) {
    message.value = 'Token invalide ou manquant'
...
const setPassword = async () => {
  ...
  try {
    ...
    message.value = 'Mot de passe créé avec succès ! Redirection...'
    ...
    message.value = err?.data?.message || 'Erreur lors de la création du mot de passe'
    messageType.value = 'error'
  } finally {
